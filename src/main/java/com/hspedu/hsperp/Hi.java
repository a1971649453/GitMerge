...
public class Hi {
    public static void main(String[] args) {
        ...
        System.out.println("hi fpr v3.0-增加功能 okok 测试冲突 ??? hello302");

        System.out.println("hi fpr v3.0-增加功能 okok 测试冲突 ??? hello301");
        System.out.println("hi fpr v3.0-增加功能 okok 测试冲突 ??? hello303");
